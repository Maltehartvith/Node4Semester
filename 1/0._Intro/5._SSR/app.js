...
const frontpageConCat = nav.replace("%%TITLE_PLACEHOLDER%%", "Front page") + frontpage + footer;
const themeparkConCat = nav.replace("%%TITLE_PLACEHOLDER%%", "Theme park") + themeparkPage + footer;
